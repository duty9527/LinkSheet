...
internal class IntentResolverCommonTest : BaseUnitTest {
    ...
    fun `test shouldFollowRedirects`() = dataTest(
        ...
        test = { (enabled, mode, skipBrowser, isReferrerBrowser, hasManualFlag) ->
            IntentResolverCommon.shouldFollowRedirects(enabled, mode, skipBrowser, isReferrerBrowser, hasManualFlag)
        },
